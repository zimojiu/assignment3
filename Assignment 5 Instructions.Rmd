---
title: "Assignment 5: K Means Clustering"
author: "Charles Lang"
date: "February 27, 2016"
output: html_document
---

In this assignment we will be applying the K-means clustering algorithm we looked at in class. At th efollowing link you can find a description of K-means, create a webpage index in Zotero and add some notes about the use and limitations of K-means clustering:
...
Now, upload the file "Class_Motivation.csv" from the Assignment 5 Repository as a data frame called "K1""
```{r}
...
This file contains the self-reported motivation scores for the class over the last five weeks. We are going to look for patterns in motivation over this time and sort people into clusters based on those patterns.
